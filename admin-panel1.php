                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                      ...
                      $med_str = '';
                      $med_q = mysqli_query($con, "SELECT m.name, d.quantity FROM doctor_prescribed_meds d JOIN medicationstb m ON d.med_id = m.id WHERE d.app_id = '$ID'");
                      if ($med_q) {
                      ...
                      $pres_display = "";
                      if ($med_str != "") {
                        $pres_display .= "<b>From Stock:</b><br>" . $med_str;
                      }
                      if ($pres != "") {
                        $pres_display .= "<b>Notes:</b><br>" . nl2br($pres);
                      }
